...

{
	...
	*/
    ...
    //==========================jiffies========================
    //printf("\njiffies start\n");
	fp = popen("cat /proc/timer_list | grep \"jiffies:\"","r");
    unsigned char* str3_temp = (unsigned char*)malloc(128);
    if( !fread(str3,1,2048,fp)){
